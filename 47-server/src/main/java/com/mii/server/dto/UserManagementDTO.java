...
public class UserManagementDTO {
  ...
  //buat nampilin
    public UserManagementDTO(String Prefic, Integer employeeId, String employeeName, Date birthDate, String gender, String email, String street1, String street2, String villageName, String zipCode, String subdistrictName, String kab, String districtName, String provinceName) {
        this.Prefix = Prefix;
        this.employeeId = employeeId;
        this.employeeName = employeeName;
        this.birthDate = birthDate;
