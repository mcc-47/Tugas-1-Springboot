...
public class DistrictRestController {
    ...
    public ResponseEntity<Districts> get(@PathVariable Integer id) {
        try {
    ...
    //update
    @PutMapping("disupdate{id}")
    public ResponseEntity<?> update(@RequestBody Districts districts, @PathVariable Integer id) {
        try {
    ...
    @PatchMapping("districtupdate/{id}")
    public ResponseEntity<?> updateDistrict(@PathVariable Integer id, @RequestBody Districts districts){
